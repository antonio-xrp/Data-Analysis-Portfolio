# Data-Analysis-Portfolio guide installation
...
activate data_analysis_portfolio
```
...
To move beyond notebook prototyping, all reusable code should go into the `data_analysis_portfolio/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `data_analysis_portfolio` folder and use the modules inside your notebooks :
...
```python
from data_analysis_portfolio.utils.paths import data_dir
data_dir()
```
